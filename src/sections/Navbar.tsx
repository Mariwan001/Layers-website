    ...
    return (
        ...
        >
                <div className="container max-w-5xl">
                    <div className="border border-white/15 rounded-[27px] bg-neutral-950/70 backdrop-blur md:rounded-full">
                    <div className=" grid grid-cols-2 lg:grid-cols-3 p-2 px-4 md:pr-2 items-center">
                        ...
                        <line x1="3" y1="6" x2="21" y2="6" className={twMerge(isOpen && "origin-left transition rotate-45 -translate-y-1")}></line>

                            <line x1="3" y1="12" x2="21" y2="12" className={twMerge(isOpen && "transition opacity-0")}></line>

                        <line x1="3" y1="18" x2="21" y2="18" className={twMerge(isOpen && "origin-left transition -rotate-45 translate-y-1")}></line>
